...
set_multicycle_path -from [get_clocks {pll|altpll_component|auto_generated|pll1|clk[2]}] -to [get_clocks {pll|altpll_component|auto_generated|pll1|clk[0]}] -setup 2
set_multicycle_path -from [get_clocks {pll|altpll_component|auto_generated|pll1|clk[2]}] -to [get_clocks {pll|altpll_component|auto_generated|pll1|clk[0]}] -hold 1
